...
import rashik from '../images/rashik.jpg'
import ldd from '../images/ldd.webp'
...
function Sidebar() {
    ...
    const { data: session } = useSession({
      required:true,
      onUnauthenticated(){
        //the user is not authenticated, we'll handle it here
        router.push("/home");
      }
    ...
    <div className="space-y-2 min-w-max max-w-lg ">
        ...
        <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
            <div className="relative w-full h-14">
                <Image src="https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto/wp-cms/uploads/2021/03/LinkedIn-Default-Background-2020-.jpg" layout="fill" />
            </div>
            <Avatar
          onClick={signOut}
          ...
          className="!h-14 !w-14 !border-2 !absolute !top-4 !cursor-pointer"
            ...
            <div className="mt-5 py-4 space-x-0.5">
                <h4 className="hover:underline decoration-purple-700 underline-offset-8 cursor-pointer">{session?.user?.name}</h4>
            ...
            <div className=" hidden md:inline text-left dark:text-white/75 text-sm"> 
                <div className="font-medium sidebarButton space-y-0.5">
                  <div className=" flex justify-between space-x-2 ">
                      <h4>People visited your post</h4>
        ...
        rounded-lg overflow-hidden flex-col space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
           ...
           <div className="flex items-center justify-between ">
              <p className="sidebarLink">Contests</p>
              <AddRoundedIcon className="!h-5" />
            </div> 
            <p className="sidebarLink">Liked Posts</p>
